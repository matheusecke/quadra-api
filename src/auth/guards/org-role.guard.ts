...
import { ORG_ROLE_KEY } from '../decorators/org-roles.decorator';
...
export class OrgRoleGuard implements CanActivate {
  ...
  canActivate(context: ExecutionContext): boolean {
    ...
    // Defensive: JwtAuthGuard should run first in the explicit guard chain.
    // This branch still protects standalone or misordered usage.
    if (!user) {
